...
const getContent = function(content) {
...
const copyFromXML = function(xml, dest, fields) {
...
const maybePromisify = function(callback, promise) {
...
const getEncodingFromContentType = function(contentType) {
...
// Setup this way to include the options - this allows for attrkey to be set in xml2js
module.exports = (args) => {
  options = args
  return {
    stripHtml,
